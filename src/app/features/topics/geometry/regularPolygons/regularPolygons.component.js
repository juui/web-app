...
class RegularPolygonsController {
  ...
  constructor($document, $timeout) {
    ...
    // //'L 44.09830056250526 61.2214747707527 L 155.90169943749473 24.894348370484636 L 225 119.99999999999997z'
    // const A = snap.text(155.90169943749476, 215.10565162951536, ['A']);
    // A.transform('t100,100r40,200,200');
    // snap.text(44.09830056250526, 178.77852522924732, ['B']);
    //
    // snap.text(44.09830056250526, 61.2214747707527, ['C']);
    // snap.text(155.90169943749473, 24.894348370484636, ['D']);
    // snap.text(225, 119.99999999999997, ['E']);
  ...
  automaticPolygons() {
    ...
    for (let i = this.MIN_SIDES; i < this.MAX_SIDES; ++i) {
      ...
      this._animationQueue.push(timer);
    }
